...
**Helium**, a floating browser window that allows you to watch media while you work, _https://github.com/JadenGeller/Helium_ and its successor _https://github.com/slashlos/Helium_
